		...
		<li>
			...
			<div style="display: flex;justify-content: space-between;">
				<div>
					...
					<div class="replyListDiv" id="replyListDivId">
					<button class="replyListBtn" id="replyListBtnId" data-commentNum="${d.commentNum}" ></button>
					</div> 
					</c:if>
				...
				<div>
					<c:if test="${member.id eq d.id}"> 
						<button class="updateBtn" data-commentNum="${d.commentNum}" id="updateBtn" > 수정 </button> <button class="butt" data-commentNum="${d.commentNum}" id="btn"> 삭제 </button>
					</c:if>
				</div>
			</div>
		</li>
