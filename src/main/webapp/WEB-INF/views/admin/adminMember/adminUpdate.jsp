	...
	<c:import url="/WEB-INF/views/admin/adminTemp/sidebar.jsp"></c:import>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
			...
			<form action="adminUpdate" method="post">
				...
				<input type="hidden" id="adminId" name="adminId" value="${adminDTO.adminId}">
				...
				<div class="mb-3">
				  ...
				  <input type="text" name="adminName" value="${adminDTO.adminName}" class="form-control" id="adminName" placeholder="Name을 입력하세요">
				</div>
