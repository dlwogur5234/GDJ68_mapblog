	                    ...
	                    <div class="row">
	                        <div class="col-xl-12">
	                            <div class="hero-cap text-center">
	                                <h3 class="titleStyle">Meeting List</h3>
	                            </div>
	                        </div>
	                    </div>
	                </div>
	            ...
	            <tbody>
	                <c:forEach items="${list}" var="n">
	                	<tr>
		                    ...
		                    <td><a href="/admin/adminMeeting/detail?meetingNum=${n.meetingNum}">${n.title}</a></td>
	    ...
	    <nav aria-label="Page navigation example">
			  <ul class="pagination justify-content-center" id="page">
			    <li class="page-item ${pager.pre?'':'disabled'}">
			      <a class="page-link" href="/admin/adminFeed/list?page=${pager.page-1}" aria-label="Previous">
			        <span aria-hidden="true">&laquo;</span>
			      </a>
			    </li>
			  
			    <c:forEach begin="${pager.startNum }" end="${pager.lastNum}" var="i">
			    <li class="page-item"><a class="page-link" href="/admin/adminFeed/list?page=${i}">${i}</a></li>
			    </c:forEach>
			
			    <li class="page-item ${pager.next?'':'disabled'}">
			      <a class="page-link" href="/admin/adminFeed/list?page=${pager.page+1}" aria-label="Next">
