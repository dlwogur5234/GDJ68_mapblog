   ...
   <body>
    ...
    <main>
		...
		<div class="col-lg-12 text-center">
			<h2 style="font-size:40px">회원 가입</h2>
		</div>
		...
		<form action="./join" method="POST" id="fr" enctype="multipart/form-data">
			...
			<div>
				<label></label>
				<input type="text" class="td" id="name" name="name" placeholder="NAME을 입력하세요">
			</div>
			<div id="nameResult" class="x">이름을 확인하세요(필수)</div><br>
			<div>
				<label></label>
				<input type="text" class="td" id="nickName" name="nickName" placeholder="NICKNAME을 입력하세요">
			<div id="nickNameResult" class="x">닉네임을 확인하세요(필수)</div><br>
			</div>
			<div>
				<label></label>
				<input type="text" class="td" id="email" name="email" placeholder="EMAIL을 입력하세요">
			</div>
			...
			<div class="o" id="phoneResult">핸드폰 번호는 필수 X</div><br>
			<div>
			<div>
				<label></label>
				<input type="text" class="td" id="url" name="url" placeholder="사용하실 개인 전용 URL을 입력하세요">
			</div>
			<div id="urlResult" class="x">URL을 확인하세요(필수)</div><br>
			<div>
				<label></label>
			...
			<div id="birthResult" class="x">생일을 확인하세요(필수)</div><br>
				...
				<input type="radio" id="p1" name="publics" value="1" class="bb">
				<label for="p1" id="p11">전체 공개</label>
				<input type="radio" id="p2" name="publics" value="0" class="bb">
