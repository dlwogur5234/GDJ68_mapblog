   ...
   <body>
    ...
    <main>
		...
		<div class="col-lg-12 text-center">
			   <h2 style="font-size:40px">회원 가입 [네이버]</h2>
		</div>
		...
		<form action="../member/join" method="POST" id="fr" enctype="multipart/form-data">
			...
			<div>
				<label></label>
				<input type="text" class="td" id="name" name="name" value="${naverMember.name}" readonly>
			</div>
			<div><br>
			<div>
				<label></label>
			...
			<div>
				<label></label>
				<input type="text" class="td" id="email" name="email" value="${naverMember.email}" readonly>
			</div><br>
				<label></label>
